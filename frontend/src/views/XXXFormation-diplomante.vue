<template>
  <div class="container">
      <div class="proj">
        <img src="../assets/maquette/maq-gle/maq-1.png" alt="😍" class="proj-prev--pic">
      </div>
      <div class="proj">
          <div class="card1">
                <div class="moncercle">
                ...
                <div class="p0Nav" @click="isShowingGle ^= true">Formation
                </div>
                <div v-show="isShowingGle">
          ...
          <div class="card2">
                ...
                <div class="p0Nav"  @click="isShowingFinale ^= true">Inscription
                </div>
                <div v-show="isShowingFinale">
