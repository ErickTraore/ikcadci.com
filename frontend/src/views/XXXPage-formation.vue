...
<div>
     <div>
      <img src="../assets/maquette/maq-gle/maq-4.png" alt="😍" >
     </div> 
     <div class="proj">
         <div class="proj--card">
                <div class="proj--card--title" @click="isShowingGle ^= true">Formation</div>
                <div class="proj--card--show" v-show="isShowingGle"> 
                    ...
                    <div class="proj-frame">
                              ...
                              <div v-show="isShowingHeigth">
                                ...
                                <table>
                                    <tr>
                                      <td rowspan="3">Semestre 1</td>
                                      <td>KMT 7007 Théorie et méthodologie de l’afrocentricité</td>
                                    </tr>
                                    <tr>
                                      <td>KMT 7017 Historiographie diopienne</td>
                                    </tr>
                                    <tr>
                                      <td>KMT 7027 Initiation à la langue des Mdw Ntr: Écriture et Grammaire</td>
                                    </tr>
                                    <tr>
                                      <td rowspan="3">Semestre 2</td>
                                      <td>KMT 7037 Les grands mouvements de la pensée africaine</td>
                                    </tr>
                                    <tr>
                                      <td>KMT 7047 Préhistoire et Histoire ancienne de l’Afrique</td>
                                    </tr>
                                    <tr>
                                      <td>KTM 7057 Initiation à la langue des Mdw Ntr: Ecriture et Grammaire</td>
                                    </tr>

                                    <tr>
                                      <td rowspan="3">Semestre 3</td>
                                      <td>KMT 7067 Spiritualité et renais- sance africaines</td>
                                    </tr>
                                    <tr>
                                      <td>KMT 7077 Histoire et civilisations de l’époque impériale</td>
                                    </tr>
                                    <tr>
                                      <td>KMT 7087 Initiation à la Langue des Mdw Ntr : Ateliers de Lecture et Traduction de Textes</td>
                                    </tr>
                                    <tr>
                                      <td rowspan="3">Semestre 4</td>
                                      <td>KMT 7097 Histoire et culture de la diaspora africaine</td>
                                    </tr>
                                    <tr>
                                      <td>KMT 7107 Les grandes invasions de l’Afrique</td>
                                    </tr>
                                    <tr>
                                      <td>KMT 7117 Langue Pan-Africaine Moderne: Le Kiswahili</td>
                                    </tr>
                                </table>
                                <div>
                                ...
                                <table>
                                        <tr>
                                          <td rowspan="3">Semestre 5</td>
                                          <td>KMT 7127 Séminaire de Recherche en Kamitologie</td>
                                        </tr>
                                        <tr>
                                          <td>KMT 7137 Littérature Africaine et Diasporique</td>
                                        </tr>
                                        <tr>
                                          <td>KMT 7147 Rekh Necher et la Tradition Scientifique Africaine</td>
                                        </tr>

                                        <tr>
                                          <td>Semestre 6</td>
                                          <td>KMT 7157 Elaboration & Soutenance du Mémoire de Pré- Thèse en Kamitologie</td>
                                        </tr>
                                        <tr>
                                          <td>Semestre 7</td>
                                          <td>KMT 7167 Elaboration de la Thèse en Kamitologie</td>
                                        </tr>
                                        <tr>
                                          <td>Semestre 8</td>
                                          <td>KMT 7177 Soutenance de Thèse en Kamitologie</td>
                                        </tr>
                                </table>
                              </div>
                    </div> 
           ...
           <div class="proj--card">
                 <div class="proj--card--title"  @click="isShowingFinale ^= true">Inscription
                </div>
                <div class="proj--card--show"  v-show="isShowingFinale">
                    <div class="proj-frame">Fiche d'inscription.</div>
                </div>
          </div>
     </div>
</div>
