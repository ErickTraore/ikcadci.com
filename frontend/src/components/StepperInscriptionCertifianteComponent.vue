...
<div id="app">
       <div class="container">
            ...
            <div class="col-md-12 internalPadding">
                          <div class="blueBar" @click="isShow['Diehardsix'] = !isShow['Diehardsix']" :class="{'red': isShow['Diehardsix']}">
                            <div class="d-flex">
                              <h2><i class="fas fa-sleigh"></i>&nbsp; &nbsp;Inscription certifiante</h2>
                              <div class="ml-auto">
            ...
            <div class="row content internalPadding" v-if="isShow['Diehardsix']">
            <div class="col-12">
 ...
 <div class='thing'>
        <div class='thing__header'>
                <div class='thing__header__body'>
                    <div class='thing__header__body__title'> Formulaire d'inscription.</div>
                </div>
          ...
          <!-- <div>Biographie: {{ profile.biographie}}</div> -->
            ...
            <div>Formation selectionnée seshsw-nsw: {{ profile.seshswNsw}}</div>
...
<!-- fin integration data -->
          <div class="col-md-12 internalPadding" style="margin-top: 15px;">
                            <div @click="isShow['Diehardsix'] = !isShow['Diehardsix']">
                              <div class="d-flex">
