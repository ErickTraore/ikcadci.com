            ...
            <div class="container" v-for="item  in pieces" :key="item .id">
                ...
                <div class="group__header__body__first"> 
                   <div class="group__header__body__first__in"> 
                      ...
                      <!-- <b>Mon id: {{ myId }}</b> <br> -->
                      <!-- <b>Mon pieceUserId: {{ item.UserId}}</b> <br> -->
                  ...
                  <div class="group__header__body__first__title"> 
                   ...
                   <div class="group__header__body__first__down"> 
                       {{ item .content }}<br> 
                    </div>             <!-- <u>Nombre de like:</u> {{ piece.likes }} -->
        </div>
...
,    },
  ...
  methods: {
    ...
    doLike: function (id) {
        ...
        this.axios.post('https://212.227.142.69:3000/api/pieces/' + id + '/vote/like', null, {
            headers: {
              'Authorization': token
            }
          }
    ...
    doDislike: function (id) {
        ...
        let myStorageToken = JSON.parse(objMySession)
        let token = myStorageToken.myToken;
        this.axios.post('https://212.227.142.69:3000/api/pieces/' + id + '/vote/dislike', null, {
            headers: {
              'Authorization': token
            }
          }
    ...
    onPostData(e) {
      e.preventDefault();
        ...
        if (!this.piece.content) {
          this.errors.push('Veillez saisir le piece');
        } else if (this.piece.content.length >= 550 || this.piece.content.length <= 3){
          this.errors.push('Votre piece doit contenir entre 4 et 550 caractères.');
        }
    ...
    removeImage: function(e) {
        ...
        axios.post('https://212.227.142.69:3000/api/pieces/delLienImage', formData, {
          headers: {
            'Authorization': token,
            'Content-Type': 'multipart/form-data' 
          }
