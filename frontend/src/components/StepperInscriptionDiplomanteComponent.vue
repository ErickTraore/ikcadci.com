    ...
    <div id="app">
            ...
            <div class="row">
                <div class="col-md-12 internalPadding">
                              <div class="blueBar" @click="isShow['Diehard'] = !isShow['Diehard']" :class="{'red': isShow['Diehard']}">
                                <div class="d-flex">
                                  <h2><i class="fas fa-sleigh"></i>&nbsp; &nbsp;Inscription diplomante</h2>
                                  <div class="ml-auto">
       ...
       <div class="container">
            ...
            <div class="col-md-12 internalPadding">
                          <div class="blueBar" @click="isShow['Diehard'] = !isShow['Diehard']" :class="{'red': isShow['Diehard']}">
                            <div class="d-flex">
                              <h2><i class="fas fa-sleigh"></i>&nbsp; &nbsp;Inscription en ligne</h2>
                              <div class="ml-auto">
                                <i class="fas fa-plus ml-auto"></i>
                              </div>
                            </div>
...
<!--Debut integration-x2 texe info-inscription-->
            <div class='thing'>
 ...
 <!--Fin integration-x2 texe info-inscription-->
          <div class="col-md-12 internalPadding" style="margin-top: 15px;">
                            <div @click="isShow['Diehardtwo'] = !isShow['Diehardtwo']">
                              <div class="d-flex">
  ...
  <!--Fin integration-3 texe info-inscription-->
  <!--Debut integration-4 texe info-inscription-->
            <div class="row">
            <div class=" col-md-12 internalPadding ">
                          <div class="blueBar" @click="isShow['Diehardtree'] = !isShow['Diehardtree']" :class="{'red': isShow['Diehardtree']}">
                            <div class="d-flex">
                              <h2><i class="fas fa-sleigh"></i>&nbsp; &nbsp;SESHSW-NSW</h2>
                              <div class="ml-auto">
                                <i class="fas fa-plus ml-auto"></i>
                              </div>
                            </div>
...
<!-- fin integration data -->
          <div class="col-md-12 internalPadding" style="margin-top: 15px;">
                            <div @click="isShow['Diehardtree'] = !isShow['Diehardtree']">
                              <div class="d-flex">
                              <button class="ml-auto">
                                <slot>Fermer</slot>
                              </button>
  ...
  <!--Fin integration-4 texe info-inscription-->
